...
exports.fryganiesKroyton = async function(req, res, next) {
    await getProductsByCategory(req, res, "proionta artou", "fruganies krouton", );
}

exports.fruganies = async function(req, res, next) {
    await getProductsByCategory(req, res, "proionta artou", "fruganies krouton", "fruganies");
}

exports.kroyton = async function(req, res, next) {
    await getProductsByCategory(req, res, "proionta artou", "fruganies krouton", "krouton");
}
