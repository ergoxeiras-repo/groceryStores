...
exports.vrefikaAporrypantika = async function(req, res, next) {
    await getProductsByCategory(req, res, "vrefikh frontida", "vrefika aporrupantika");
}

exports.ygraAporrypantika = async function(req, res, next) {
    await getProductsByCategory(req, res, "vrefikh frontida", "vrefika aporrupantika", "ugra aporrupantika");
}

exports.malaktika = async function(req, res, next) {
    await getProductsByCategory(req, res, "vrefikh frontida", "vrefika aporrupantika", "malaktika");
}