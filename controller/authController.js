...
exports.signup = async function (req, res, next) {
    ...
    try{
        ...
        next(new ThrowsAnError("Ο χρήστης δεν μπορεί να δημιουργηθεί", 400));
    }    
}
...
exports.login = async function (req, res, next) {
    ...
    try {
        ...
        next(new ThrowsAnError("Η σύνδεση απέτυχε", 400));
    }
}
...
exports.updatePassword = async function (req, res, next) {
    ...
    const isCorrect = await isThePasswordCorrect(user, currentPassword, next);
